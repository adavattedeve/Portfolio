...
Properties {
    ...
    _MainRoughnessSource ("'Roughness Source' {Dropdown:{PackedMapAlpha:{_PrimarySpecularTint,_SecondarySpecularTint,_TertiarySpecularTint,_QuaternarySpecularTint}, BaseColorAlpha:{_PrimaryMaterialMap,_PrimaryOcclusion,_SecondaryMaterialMap,_SecondaryOcclusion,_TertiaryMaterialMap,_TertiaryOcclusion,_QuaternaryMaterialMap,_QuaternaryOcclusion}}}", Float) = 0
