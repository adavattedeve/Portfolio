...
Properties {
    ...
    _MainRoughnessSource ("'Roughness Source' {Dropdown:{PackedMapAlpha:{_SplatSpecularTint0,_SplatSpecularTint1,_SplatSpecularTint2,_SplatSpecularTint3}, BaseColorAlpha:{_MaterialMap0,_SplatOcclusion0,_MaterialMap1,_SplatOcclusion1,_MaterialMap2,_SplatOcclusion2,_MaterialMap3,_SplatOcclusion3}}}", Float) = 0
