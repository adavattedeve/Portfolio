...
{
    s.diffuseWrap = 0.25h;
    s.highlightTangent = A_AXIS_Y;
    s.highlightTint0 = A_WHITE;
    s.highlightShift0 = 0.0h;
    s.highlightWidth0 = 0.25h;
    s.highlightTint1 = A_WHITE;
