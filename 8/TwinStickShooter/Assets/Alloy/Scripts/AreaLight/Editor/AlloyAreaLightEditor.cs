...
public class AlloyAreaLightEditor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        var isAnimatedByClip = serializedObject.FindProperty("m_isAnimatedByClip");
        ...
        // Animated by Clip.
        isAnimatedByClip.boolValue = EditorGUILayout.Toggle("Animated by Clip", isAnimatedByClip.boolValue);
