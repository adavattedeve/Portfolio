...
public static class AlloyMigrationTools {
    ...
    [MenuItem(AlloyUtils.MenubarPath + "Material Report", false, 11)]
    ...
    [MenuItem(AlloyUtils.MenubarPath + "Material Migrator", false, 11)]
    ...
    [MenuItem(AlloyUtils.MenubarPath + "Light Converter", false, 11)]
